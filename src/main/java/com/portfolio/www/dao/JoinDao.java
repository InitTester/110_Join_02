...
public class JoinDao extends JdbcTemplate {
	...
	public int join(HashMap<String,String> params) {
		...
		// 회원 성
		String name_last = params.get("name_last") ;
		// 회원 비밀번호
		...
		String sql = "INSERT INTO forum.`member` " +
		         "(member_id, passwd, member_nm, email, auth_yn, pwd_chng_dtm, join_dtm,name,name_last) " +
...
//		log.info("\n\n sql : "+sql+"\n\n");
		 ...
		 * */
		return update(sql, passwd, email, name, name_last);
	}
}
